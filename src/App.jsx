...
function App() {
  ...
  const [ai_difficulty, set_ai_difficulty] = useState(1);
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path = "/difficulty" element = {<DifficultySelection setDifficulty={set_ai_difficulty} />} />
        ...
        <Route path = "/game/ai" element = {<GamePlay key = {game_id} player_names={player_names} version={"ai"} grid_size={grid_size} ai_difficulty={ai_difficulty} set_game_id={set_game_id} />} />
